...
results_df = pd.DataFrame(final_results, columns=["Dataset", "Model", "Accuracy", "AUC"])
...
plt.title("Node Classification Accuracy by Dataset and Model")
plt.ylabel("Accuracy")
plt.ylim(0,1)
...
# Plot AUC per model and dataset
plt.figure(figsize=(10,5))
sns.barplot(data=results_df, x="Dataset", y="AUC", hue="Model")
plt.title("Node Classification AUC by Dataset and Model")
plt.ylabel("AUC")
plt.ylim(0,1)
plt.legend(title="Model")
plt.tight_layout()
...
# Optional: Combined Accuracy + AUC comparison
results_melted = results_df.melt(id_vars=["Dataset", "Model"], value_vars=["Accuracy", "AUC"], var_name="Metric", value_name="Score")
plt.figure(figsize=(10,6))
sns.barplot(data=results_melted, x="Dataset", y="Score", hue="Metric", style="Model", ci=None)
sns.stripplot(data=results_melted, x="Dataset", y="Score", hue="Model", dodge=True, marker="o", alpha=0.7, linewidth=1, palette="dark")
plt.title("Comparison of Accuracy and AUC per Dataset")
plt.ylabel("Score")
plt.ylim(0,1)
